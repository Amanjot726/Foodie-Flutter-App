                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(50),
                                    child: Image.asset("assets/Small_Done.png",height: 16.5,width: 16.5,fit: BoxFit.fill,)
                                  ),
                                  SizedBox(width: 6,),
                                  Text("Home",
                                    style: TextStyle(
                              ...
                              InkWell(
                                            ...
                                            children: [
                                              ...
                                              StreamBuilder(
                                                  ...
                                                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                                                    ...
                                                    _grand_total = _total + Other_Taxes;
                                ...
                                onTap: ()async {
                                  if(paymentMethod.isNotEmpty){
                                    ...
                                    int result = await Navigator.push(context, MaterialPageRoute(builder: (context) => RazorPayPaymentPage(amount: _grand_total),));
