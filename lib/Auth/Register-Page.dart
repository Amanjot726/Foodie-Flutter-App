  ...
  void RegisterUser(BuildContext context) async{
    try {
      ...
      if(userCredential.user!.uid.toString().isNotEmpty){
        ...
        // FirebaseFirestore.instance.collection("users").doc().set(dataToSave).onError((error, stackTrace) => print("error = ${error}"));
                                  ...
                                  prefixIcon: ClipRRect(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: _Name_focus_node.hasFocus ? Color.fromARGB(243, 93, 177, 108) : Colors.black45
                                      ),
                                      child: Icon(
